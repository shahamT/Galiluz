...
6. rawPrice: String from message (e.g. "50" or "חינם"). price: number or 0 (free) or null. Free entry: חינם, בחינם, חופשי, כניסה חופשית, ללא תשלום → price: 0. Use the MAIN/STANDARD price only — NOT last-minute or day-of price (e.g. "50 ש״ח עד למועד האירוע, 60 ש״ח ביום האירוע" → use 50), NOT bundle price (e.g. "100 ש״ח לכרטיס, 180 ש״ח לשני כרטיסים" → use 100). Prefer the single-ticket or advance price when multiple options exist.
