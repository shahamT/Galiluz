...
export const SEO_DEFAULT_DESCRIPTION =
  'גלילו"ז (גלילוז) – יומן אירועים ופעילויות בגליל, בגולן ובצפון. גלו מה קורה היום — מסיבות, הופעות, סדנאות ומה לעשות בסופ"ש.'

export const SEO_DEFAULT_TITLE = 'גלילו"ז (גלילוז) | אירועים ופעילויות בגליל, בגולן ובצפון'
...
export const SEO_PAGES = {
  ...
  dailyView: {
    title: 'אירועים היום בצפון | גלילו"ז (גלילוז)',
    description:
      'גלו מה קורה היום בגליל, בגולן ובצפון — מסיבות, הופעות, סדנאות ופעילויות. יומן אירועים מעודכן של גלילו"ז (גלילוז).',
  },
  monthlyView: {
