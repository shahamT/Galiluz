...
| broadcasts | `broadcasts` | Admin WhatsApp broadcast audit: `{createdBy, createdByName, recipientCount, hasImage, imageUrl, messageTemplate, createdAt}` | Forever | One per broadcast (low volume) |
