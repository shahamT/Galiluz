<template>
  <div class="AdminSecurity">
    ...
    <NuxtLink to="/admin/settings" class="AdminSecurity-back">
      <UiIcon name="arrow_forward" size="sm" />
      חזרה להגדרות
    </NuxtLink>

    <div class="AdminSecurity-header">
      <h1 class="AdminSecurity-title">מפתחות גישה (Passkeys)</h1>
      <p class="AdminSecurity-subtitle">
        מפתחות גישה הם גורם האימות השני לכניסת צוות — טביעת אצבע, זיהוי פנים או מפתח אבטחה.
