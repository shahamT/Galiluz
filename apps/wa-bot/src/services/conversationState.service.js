...
const STEPS = {
  ...
  PUBLISH_ASK_TERMS_APPROVAL: 'publish_ask_terms_approval',
  ...
  EVENT_ADD_EDIT_CATEGORIES_CHOICE: 'event_add_edit_categories_choice',
  EVENT_ADD_EDIT_LOCATION_PLACE: 'event_add_edit_location_place',
  EVENT_ADD_EDIT_LOCATION_CITY: 'event_add_edit_location_city',
  EVENT_ADD_EDIT_LOCATION_REGION: 'event_add_edit_location_region',
  EVENT_ADD_EDIT_LOCATION_ADDRESS: 'event_add_edit_location_address',
  EVENT_ADD_EDIT_LOCATION_NOTES: 'event_add_edit_location_notes',
