...
export const EVENT_EDIT = {
  ...
  SUCCESS_MORE_BUTTON: { id: 'edit_success_more', title: 'לעדכון פרטים נוספים' },
  ...
  EXTRA_CATEGORIES_BODY: 'אלו הקטגוריות אליהן משויך כעת האירוע',
  ...
  EXTRA_BACK_BUTTON: { id: 'edit_extra_back', title: 'סיימתי לעדכן קטגוריות' },
